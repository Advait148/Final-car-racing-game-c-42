class Game {
  ...
  handlePlayerControls() {
    ...
    if (keyIsDown(LEFT_ARROW) && player.positionX > width / 3 - 50 && this.blast === false) {
      player.positionX -= 5;
      player.update();
      this.leftKeyActive = true;
    }

    if (keyIsDown(RIGHT_ARROW) && player.positionX < width / 2 + 300 && this.blast===false) {
      player.positionX += 5;
      player.update();
      this.leftKeyActive = false;
    }
  ...
  showRank() {
    ...
    showLife(){
      image(lifeImage,width/2-130,height-player.positionY-60,20,20);
      push()
      fill("white")
      rect(width/2-100,height-player.positionY-60,185,20);
     
      fill("red")
      rect(width/2-100,height-player.positionY-60,player.life,20);
      pop();
     }
